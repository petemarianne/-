class AdList {
    ...
    static validate(adItem, params = ['id', 'description', 'createdAt','vendor', 'photoLink', 'hashTags', 'link', 'discount', 'validUntil', 'rating', 'reviews']) {
    ...
    edit(id, adItem) {
        for (var param in adItem) {
            if (param === 'id' || param === 'createdAt' || param === 'vendor') {
                console.log('You can\'t change id, vendor or time');
                return false;
            }
        }
...
//methods tests
//all ads will be sorted by descending date

console.log("Top 5 ads:");
console.log(ads.getPage(0, 5));

console.log("Top 2 ads, skip 1 ad, vendor: Yandex:");
console.log(ads.getPage(1, 2, {vendor: 'Yandex'}));

console.log("Top 5 ads, skip 3 ads, dateFrom: 01.03.2021 :");
console.log(ads.getPage(3, 5, {dateFrom: new Date('2021-03-01T00:00:00')}));

console.log("Top 2 ads, skip 0 ads, hashtag: food:");
console.log(ads.getPage(0, 2, {hashTags: ['food']}));

console.log("getAds with incorrect inputting type:");
console.log(ads.getPage('0', 2));

console.log("Get ad with id 9:");
console.log(ads.get('9'));

console.log("Get ad with nonexistent id (50):");
console.log(ads.get('50'));

console.log("Validate ad:");
console.log(AdList.validate({id: '2', createdAt: new Date(),  description: 'description', vendor: 'vendor', hashTags: ['hashtag'], discount: '20%', validUntil: new Date(), link: 'link', photoLink: 'photoLink'}));

console.log("Invalid ad (without vendor):");
console.log(AdList.validate({id: '44', createdAt: new Date(),  description: 'description', photoLink: 'photoLink'}));

console.log("Add valid ad:");
console.log(ads.add({id: '23', createdAt: new Date(),  description: 'description', vendor: 'vendor', hashTags: ['hashtag'], discount: '90%', validUntil: new Date(), link: 'link'}));

console.log("Add invalid ad:");
console.log(ads.add({createdAt: new Date(), description: 'description', vendor: 'vendor', discount: '90%'}));

console.log("Edit added ad:");
console.log(ads.edit('23', {description: 'edited'}));

console.log("Edit unchangeable parameters:");
console.log(ads.edit('23', {id: '666', description: 'edit'}));

console.log("Delete edited ad:");
console.log(ads.remove('23'));

console.log("Try to add ads array:");
let invalid = ads.addAll([
    {
        id: '80',
        description: 'description',
        createdAt: new Date('2020-03-07T23:00:00'),
        link: 'link',
        vendor: 'vendor',
        hashTags: ['sport', 'beauty', 'gym'],
        discount: '60%',
...
console.log(invalid);
console.log("Get new added ad:");
console.log(ads.get('111'));

console.log("Clear the page and try to get ads:");
ads.clear();
